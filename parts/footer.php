      ...
      <div class="container">
        <div class="row align-items-center head">
          ...
          <div class="col-md d-flex justify-content-lg-end justify-content-center mt-4 mt-md-0">
            ...
            <a href="" class="btn btn-light mx-4 mx-md-4">
        ...
        <div class="row link">
          <div class="col-lg-4 mt-1 mt-lg-0">
            ...
            <div class="d-flex mt-4">
              ...
              <a href="https://g.page/hashmicro?share" class="text-decoration-none w-75"
          ...
          <div class="col-lg-3 mt-5 mt-lg-0">
            ...
            <div class="d-flex mt-3 link contactsec">
              ...
              <a href="tel:+6287888000015" class="text-decoration-none d-inline-flex align-items-center"
                >+62 878-8800-0015
                <span>
